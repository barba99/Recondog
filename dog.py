...
def banner():
    ...
    print("\t\t\033[97m     By:\033[1;m\033[1;31m<3\033[1;31m\033[97m @Jorge_Bárbar\033[1;m")
    ...
    while choice != '11':
        ...
        if choice == '1':
            ...
            if 'cloudflare' in pns:
                print("\033[1;31mEL CONOCIMIENTO ES LIBRE\033[1;m")
            else:
                print("\033[1;31mNoEDITADO POR @Jorge_Barba\033[1;m")
            ...
            page = input('\033[1;91mESCRIBA SU URL: \033[1;m')
            ...
            ip = input('\033[1;91mEncriba su dircecion ip: \033[1;m')
            ...
            domip = input('\033[1;91mEscriba el url o su dirección ip: \033[1;m')
            trace = "https://api.hackertarget.com/mtr/?q=" + domip
            ptrace = fetch(trace)
            print (ptrace)
 
        elif choice == '11':
            print('\033[97m11. SALIENDO\033[1;m')
 
        else:
            print('\033[1;31m[-] Opcion invalida\033[1;m')
        #except:
